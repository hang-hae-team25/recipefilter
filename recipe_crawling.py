...
for i in range(0, 3):
    ...
    for i in range(0, len(trsImg)):
        ...
        meatSet = {'오리 훈제', '스팸 작은거', '차돌 또는 등심', '소고기(양지)', '돼지고기 (앞다리살)', '베이컨 작은 거', '돈까스', '국거리소고기', '훈제오리',
                   ...
                   '비엔나소세지', '비엔나소세지 작은거', '차돌박이', '치킨스톡(생략가능)'}
        ...
        fishSet = {'쭈꾸미', '꽁치캔', '낙지(大)', '손질된 고등어', '숙성 연어', '손질한 새우', '손질된 오징어', '훈제 오리고기', '마일드 참치', '명태살', '생새우',
                   ...
                   '손질 오징어', '오징어몸통',
                   '깐새우', '참치캔 150g짜리', '연어', '고등어', '냉동 새우살', '새우', '냉동새우', '칵테일새우', '황태채', '오징어', '칵테일 새우', '멸치',
                   '전복'}
        ...
        vegiSet = {'다진홍청양고추', '브로콜리 작은', '빨강파프리카', '페페론치노', '마늘 다진것', '브로컬리', '다진청피망', '완숙토마토', '알배추 작은 거',
                   ...
                   '마늘', '파프리카(빨강/노랑) 각', '마늘(편으로썬)', '파프리카(노랑/빨강)', '쪽파or대파', '청 고추 &홍 고추', '알배추', '느타리버섯', '어린잎채소',
                   '작은양파',
                   '노란 파프리카', '파프리카 빨강이', '쌀밥', '새송이버섯', '양배추', '각종자투리 야채', '숙주나물', '다진파', '쪽파 또는 대파', '콩나물', '다진마늘',
                   '대파 잎', '송송 썬 쪽파',
